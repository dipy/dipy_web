...
FOD/ODF fields :footcite:`meesters2016`, implementing the contextual PDE
framework of :footcite:`portegies2015a` for processing HARDI data. The aim is
...
of coupled positions and orientations :math:`\mathbb{R}^3 \rtimes S^2`. This
...
The kernel :math:`P_t` has a stochastic interpretation :footcite:`duitsandfranken2011`.
...
.. figure:: ../_static/stochastic_process.jpg
   ...
   :footcite:`portegies2015a`.

In practice, as the exact analytical formulas for the kernel :math:`P_t`
are unknown, we use the approximation given in :footcite:`portegies2015b`.
...
###############################################################################
# Inspired by :footcite:`rodrigues2010`, a lookup-table is created, containing
...
###############################################################################
# .. centered:: **Visualization of the contour enhancement kernel.**
#
#
